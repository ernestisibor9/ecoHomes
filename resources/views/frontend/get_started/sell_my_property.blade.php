                        ...
                        <form action="{{route('store.sell.my.property')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    @error('lastname')is-invalid @enderror"
                                        placeholder="Last Name" aria-label="Last name" name="lastname"
                                        required>
                                    @error('lastname')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12">
                                    ...
                                    <select name="country_id" class="form-control see
                                     @error('country_id')is-invalid @enderror " required style="display: block">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-12 col-md-6" id="select-state-group" style="display: none;">
                                    ...
                                    <select name="state_id" class="form-control see
                                    @error('state_id')is-invalid @enderror " required style="display: block">
