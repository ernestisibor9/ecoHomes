            ...
            <div class="col-md-10">
                ...
                <div class="card shadow p-2">
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.flat') }}" method="POST" class="row g-3"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control  @error('property_title')is-invalid @enderror "
                                    id="" name="property_title" placeholder="3-Bedroom Apartment for Sale in Lagos"
                            ...
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Types of Flat</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('size')is-invalid @enderror" id=""
                                    name="size" value="{{ old('size') }}" placeholder="e.g., 500 sqm">
                                @error('size')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('address')is-invalid @enderror " id="autocomplete" rows="3"
...
<script>
    function initMap() {
        ...
        let autocomplete = new google.maps.places.Autocomplete(document.getElementById('autocomplete'), {
            types: ['geocode'] // Restricts to geographical locations
        });
        ...
        // Allow marker dragging to update lat/lng
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNbcYZgvX1NfyeTb4k8q3_g5Y6OIBF5l8&libraries=places&callback=initMap">
    </script>
