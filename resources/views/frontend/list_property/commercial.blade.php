            ...
            <div class="col-md-10">
                ...
                <div class="card shadow p-2">
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.commercial') }}" method="POST" class="row g-3"
                            ...
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Types of Commercial Property</label>
                            ...
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Number of Floors</label>
                                <input type="number" class="form-control @error('floor')is-invalid @enderror"
                                    id="" name="floor" value="{{ old('floor') }}" min="0">
                                @error('floor')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Condition of Property</label>
                                <select id="inputState"
                                    class="form-select @error('condition')is-invalid @enderror see"
