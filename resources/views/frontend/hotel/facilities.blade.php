        ...
        <div class="col-md-10">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form action="{{ route('hotel.facilities.store', ['hotel' => $hotel->id]) }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{route('hotel.create')}}" class="theme-btn btn-one bg-danger text-decoration-none mr-5" id="backButton">Back</a>
