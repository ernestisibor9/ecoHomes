        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 text-column">
                <div class="title-text">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing sed do eiusmod tempor incididunt labore dolore magna aliqua enimad minim veniam. quis nostrud exercitation laboris nis aliquip ex ea commodo consequat.</p>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-lg-6 col-md-12 col-sm-12 news-block">
                <div class="news-block-two wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box align-items-center">
                        <div class="image-box">
                            <figure class="image"><a href="blog-details.html"><img src="{{asset('frontend/assets/images/news/news-4.jpg')}}" alt=""></a></figure>
                        ...
                        <div class="content-box">
                            ...
                            <ul class="post-info clearfix">
                                <li class="author-box">
                                    ...
                                    <h5><a href="blog-details.html">Tom Jack</a></h5>
                                </li>
                                <li>April 08, 2020</li>
                            </ul>
                            <p>Lorem ipsum dolor consectetur adipisicing sed.</p>
