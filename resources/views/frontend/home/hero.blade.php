                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="field-input">
                                                                ...
                                                                <input type="search"name="location" placeholder="Search by Property, Location or Landmark..." required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                ...
                                                                <select class="wide">
                                                                   <option data-display="Input Type">Input Property Type</option>
                                                                   @foreach ($listPropertyTypes as $type)
                                                                   <option value="{{ $type->property_type }}" {{ request('property_type') == $type->property_type ? 'selected' : '' }}>
                                                                       {{ $type->property_type }}
                                                                   </option>
                                                                   @endforeach
                                                                </select>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide">
                                                                   <option data-display="Input Status">Input Property Status</option>
                                                                   @foreach ($listPropertyStatus as $status)
                                                                   <option value="{{ $status->property_status }}" {{ request('property_status') == $status->property_status ? 'selected' : '' }}>
