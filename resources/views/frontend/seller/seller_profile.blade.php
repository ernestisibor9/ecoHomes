                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            ...
                                            <small class="text-danger">(max size: 1MB)</small>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="file"
                                                class="form-control
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($profileData->photo) ? url('upload/seller_images/' . $profileData->photo) : url('upload/no_image2.jpeg') }}"
