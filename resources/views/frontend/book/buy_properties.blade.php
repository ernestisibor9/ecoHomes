                    ...
                    <div class="property-content-side">
                        <div class="item-shorting clearfix">
                            <div class="left-column pull-left">
                                <h5>Search Results: <span>Showing {{ count($buyProperties) }} Listings</span></h5>
                            </div>
                        ...
                        <div class="">
                            <div class="">
                                {!! $buyProperties->links('pagination::bootstrap-5') !!}
                            </div>
                        </div>
                    </div>
                </div>
