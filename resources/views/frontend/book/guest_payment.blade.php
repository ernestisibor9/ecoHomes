        ...
        <div class="card-body">
            <form id="paymentForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control" readonly id="email" value="{{ $email }}">
                </div>

                <!-- Full Name -->
                <div class="mb-3">
                    <label for="fullName" class="form-label">Room Number</label>
                    <input type="text" name="room_number" class="form-control" readonly id="" value="{{ $roomDetails->room_number }}">
                </div>

                <div class="mb-3">
                    <label for="fullName" class="form-label">Room Type</label>
                    <input type="text" name="room_size" class="form-control" readonly id="" value="{{ $roomDetails->room_size }}">
                </div>

                <div class="mb-3">
                    <label for="fullName" class="form-label">Total Price</label>
                    <input type="text" name="total_price" class="form-control" readonly id="" value="{{ $totalPrice }}">
                </div>
