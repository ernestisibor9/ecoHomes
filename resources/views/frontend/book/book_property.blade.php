                    ...
                    <div class="right-column pull-right clearfix">
                        <div class="price-inner clearfix">
                            <ul class="category clearfix pull-left">
                                ...
                                <li><a href="property-details.html">For Booking</a></li>
                            </ul>
                            <div class="price-box pull-right">
                                <h3>${{$property->maximum_price}}</h3>
                            </div>
                        </div>
                        ...
                        <div class="property-details-content">
                            ...
                            <div class="details-box content-widget">
                                ...
                                <ul class="list clearfix">
                                    ...
                                    <li>Property Price: <span>${{$property->maximum_price}}</span></li>
                                    <li>Bedrooms: <span>{{$property->bedrooms}}</span></li>
                                    <li>Year Built: <span>01 April, 2019</span></li>
                                    <li>Property Type: <span>{{ $property->type->type_name }}</span></li>
                                    <li>Bathrooms: <span>{{$property->bathrooms}}</span></li>
                                    <li>Property Status: <span>For {{ucfirst($property->property_status)}}</span></li>
                            ...
                            <div class="location-box content-widget">
                                ...
                                <ul class="info clearfix">
                                    <li><span>Country:</span> {{$property->country->name}}</li>
                                ...
                                <div class="google-map-area">
                                    <div class="google-map" id="contact-google-map" data-map-lat="40.712776"
                                        data-map-lng="-74.005974" data-icon-path="{{asset('frontend/assets/images/icons/map-marker.png')}}"
